...
export default function MarketDetail() {
  ...
  // currentProbability is already normalized to a number in the hook
  const probability = getMarketPrice(id) ?? market.currentProbability;
  const getProbColor = (p: number) => p >= 70 ? '#00ff88' : p >= 40 ? '#ffaa00' : '#ff3366';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="glass-card rounded-xl p-4 flex items-center justify-between">
                ...
                <div className="prob-bar w-32 h-3">
                  <div 
                    ...
                    style={{ 
                      ...
                      backgroundPosition: `${100 - probability}% 0`
                    }}
                  />
                </div>
              </div>
              ...
              >
                <div className="flex items-center gap-2 mb-3">
                  <span style={{ color: '#ffaa00' }}>RESOLUTION STATUS</span>
                ...
                {market.resolved ? (
                  ...
                  <div className="space-y-3">
                    <p style={{ color: '#66ff66' }} className="text-sm">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="sticky top-24 space-y-6">
              ...
              >
                <div className="p-3 flex items-center gap-2" style={{ borderBottom: '1px solid #66ff66' }}>
                  <History className="h-4 w-4" style={{ color: '#66ff66' }} />
                  <h3 className="font-mono font-semibold text-sm" style={{ color: '#66ff66' }}>Recent Trades</h3>
                </div>
                <div className="max-h-[200px] overflow-y-auto">
                  <table className="w-full text-xs">
                    <thead className="text-muted-foreground text-[10px] border-b border-white/5 sticky top-0 bg-black">
                      <tr>
